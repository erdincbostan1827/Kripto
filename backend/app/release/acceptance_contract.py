...
ACCEPTANCE_PLANS: Final[dict[str, tuple[tuple[str, tuple[str, ...], bool], ...]]] = {
    ...
    "restart-drills": (
        ...
        ("restart_semantic_evidence", ("bash", "scripts/external/runtime_restart_drill.sh"), True),
    ),
    "supply-chain": (("transferred_supply_chain_verification", ("python", "scripts/external/verify_transferred_supply_chain.py"), True),),
    "pitr": (("pitr_drill", ("bash", "scripts/external/pitr_restore_drill.sh"), True),),
    "ha": (("ha_drill", ("bash", "scripts/external/ha_failover_drill.sh"), True),),
    "worm": (("worm_storage", ("bash", "scripts/external/worm_storage_acceptance.sh"), True),),
    ...
    "provenance": (
        ...
        ("artifact_sign_verify", ("bash", "scripts/external/provenance_sign_verify.sh"), True),
    ),
    "campaigns": (
